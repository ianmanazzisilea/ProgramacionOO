...
public class EstacionDeServicio {
    ...
    private ArrayList<Empleado> empleados = new ArrayList<>();//sin usar descuento
    ...
    private Empleado buscarEmpleado(int id){
        ...
        String turno = myObj.nextLine();
        return new Empleado(id,nombre,turno);
    }
    public void nuevaVenta(int id, String patente, byte combustible, double cantidad, int surtidor,boolean descuentoempleado){
        ...
        Venta nuevaVenta = new Venta(empleado, patente, scombustible, cantidad, surtidor,descuento);
    ...
    public void top10clientes(){
        ...
        while ((mayor>-1)&&(cant>0)){
            ...
            if (mayor>-1){
                ...
                this.clientes.add(clientes.get(pos));
                cantidad.add(pos,-1);
            }
            cant--;
        }
