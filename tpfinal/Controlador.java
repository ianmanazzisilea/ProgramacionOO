...
public class Controlador implements IControladorRemoto, Serializable {
    ...
    public void jugada(ArrayList<Carta> indicemano,Carta indicemesa){
        try {
            modelo.jugada(indicemano,indicemesa);
        }catch (RemoteException e){
            e.printStackTrace();
        }
    ...
    public ArrayList<Carta> getMano() {
        try {
            ArrayList<Carta> mano = modelo.getMano(indice);
            return mano;
        }catch (RemoteException e){
            e.printStackTrace();
    ...
    public void descartarbonus(ArrayList<Carta> jugada){
        try {
            modelo.descartarbonus(jugada);
        }catch (RemoteException e){
            e.printStackTrace();
        }
